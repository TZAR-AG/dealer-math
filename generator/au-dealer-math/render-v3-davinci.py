# AUDM V3 — DaVinci Resolve render script.
# Configures Deliver-page render settings, adds the timeline to the render
# queue, starts rendering, and polls until complete.
#
# Run AFTER build-v3-davinci.py has assembled the timeline. Use the standard
# DaVinci Py3 Console invocation pattern that V1/V2 used to load this file.
#
# Inherits V2 render fixes (2026-04-30 MarkIn/MarkOut=-1 ghost-render bug).
# Verified against pipeline reference v3 (2026-05-05).
...
OUT_NAME = "audm-v3-aftercare-room"
...
print("=" * 60)
print("AUDM V3 - DaVinci render (full timeline)")
print("=" * 60)
